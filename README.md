...
Для поиска цитат (предложений, заключенных в одинарные кавычки) разработан конечный автомат, который обрабатывает текст посимвольно и выделяет цитаты без использования регулярных выражений. Автомат поддерживает экранированные символы (\', \\, \n, \t и др.).

Граф конечного автомата
Автомат имеет 4 состояния и работает детерминированно (ДКА).
...
└─────────┘           └──────────┘           └────────────┘           │
     │                    │  ▲                     │  ▲               │
     │                    │  │                     │  │               │
     │ any char           │  │ any char except \,'  │  │ any char except '
     │ (кроме ')          │  │                     │  │               │
     │                    │  │                     │  │               │
     │                    │  │  \                  │  │ '             │
     │                    │  │                     │  │               │
...
**Скриншоты программы**
![primer_dop](<Снимок экрана 2026-04-17 205329.png>)