...
Вариант задания: Номер варианта, его текстовое описание 2–3 примера корректных входных строк для данного варианта и перечень допустимых лексем.

Диаграмма состояний: 


Тестовые примеры: Таблицы с входными строками и соответствующими выходными последовательностями (аналогично примеру выше). Обязательно включить примеры: корректная строка; строка с недопустимым символом; многострочный пример.